package exercicios;
/*Segue a lista de exercícios Java 8+
...
public class Q6 {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println(
	    		numbers.stream()
		    		.distinct()
		    		//Separa os valores de em pares e impares retornando um Map<Boolean, List<Integer>>> 
		    		.collect(Collectors.partitioningBy(n -> n%2 != 0))
		    		//Imprime somente os conjuntos(valores) ignorando o Boolean
		    		.values()
		 );
	}
