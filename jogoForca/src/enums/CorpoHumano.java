...
public enum CorpoHumano {
	...
	TRONCO(CABECA.getValor1() + ((int)( CABECA.getValor4() / 2)),
			CABECA.getValor2()+  CABECA.getValor4(),
			CABECA.getValor1() + ((int)( CABECA.getValor4() / 2)),
			CABECA.getValor2()+  CABECA.getValor4() + (CABECA.getValor4()*2 + (int)(CABECA.getValor4()/2))
			),
